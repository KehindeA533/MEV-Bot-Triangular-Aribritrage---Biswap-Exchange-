def structure_trading_pair(pairs, limit):
    ...
    for pair_a in pairs_list:
        # Get first pair (A) (Adjust when looking at differnet exchange data #2)
            ...
            if a_pair != b_pair:
                if b_base in a_pair_box or b_quote in a_pair_box:
                    ...
                    for pair_c in pairs_list:
                        ...
                        # Count the number of (C) pairs (unquie pair)??
                        if c_pair != a_pair and c_pair != b_pair:
                            # combine_all = [a_pair, b_pair, c_pair] # Check this out in video
                            pair_box = [a_base, a_quote,
                                        b_base, b_quote, c_base, c_quote]
...
def calc_surface_rate(t_pair, min_rate, num):
    # print(t_pair["aPair"])

    # Set variables
    min_surface_rate = min_rate  # initial Captial ()
    ...
    # Set directions and loop through forward and reverse rates
    ...
    for direction in direction_list:
        ...
        # SCENARIO 2 check if aBase (acquired coin) matches bQuote
        if direction == "reverse":
        ...
        # SCENARIO 3 check if aBase (acquired coin) matches cBase
        if direction == "reverse":
        ...
        # SCENARIO 4 check if aBase (acquired coin) matches cQuote
        if direction == "reverse":
        ...
        # if acquired_coin_t3 > num: #if acquired_coin_t3 > starting_amount:
        #     print("------------------------")
